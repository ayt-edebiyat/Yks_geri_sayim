...
import yks.bilgi.yarismasi.utils.ShadowTransformer;
import yks.bilgi.yarismasi.views.CircleIndicatorView;
import yks.bilgi.yarismasi.views.FlowingGradientClass;
